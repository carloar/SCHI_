...
namespace ControlPrestamoHerramientas.Reportes
{
    ...
    public partial class ReporteHerramientasAsignadas : Form
    {
        public static int totregistros = 0;
        public ReporteHerramientasAsignadas()
        {
            InitializeComponent();
        }

        private void ReporteHerramientasAsignadas_Load(object sender, EventArgs e)
        {
            ...
            conexionbd.command.CommandText = "SELECT COUNT(*) FROM herramientas_asignadas";
